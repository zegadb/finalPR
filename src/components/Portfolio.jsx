                                    ...
                                    <div className="itemContent flex">
                                      <Common title='portfolio' />
                                        ...
                                        <div className="contentLeft">
                                          ...
                                          <ul>
                                            <li>
                                              <i className="fa fa-minus"></i>{val.p1}
                                            </li>
                                            <li>
                                              <i className="fa fa-minus"></i>{val.p2}
                                            </li>
                                            <li>
                                              <i className="fa fa-minus"></i>{val.p3}
                                            </li>
                                            <li>
                                              <i className="fa fa-minus"></i>{val.p4}
                                            </li>
                                            <li>
                                              <i className="fa fa-minus"></i>{val.p5}
                                            </li>
                                          </ul>
